...
class MyWindow(Window):
  ...
  def __init__(self):
     ...
     wpf.LoadComponent(self, 'RuiPlan3.xaml')
     #self.Topmost=True
...
def arc2():
    with CompositeAction('Add beam (1, Beam Set: 2arc)'):
        retval_0 = beam_set.CreateArcBeam(ArcStopGantryAngle=181, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1",
                                          Description="1", GantryAngle=179, CouchAngle=0, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_0.SetBolus(BolusName="")

    with CompositeAction('Add beam (2, Beam Set: 2arc)'):
        retval_1 = beam_set.CreateArcBeam(ArcStopGantryAngle=179, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2",
                                          Description="2", GantryAngle=181, CouchAngle=0, CollimatorAngle=350,
                                          ApertureBlock=None)
...
def arc4():
    ...
    with CompositeAction('Add beam (3, Beam Set: 2arc)'):
        retval_2 = beam_set.CreateArcBeam(ArcStopGantryAngle=181, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3",
                                          Description="3", GantryAngle=179, CouchAngle=0, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_2.SetBolus(BolusName="")

    with CompositeAction('Add beam (4, Beam Set: 2arc)'):
        retval_3 = beam_set.CreateArcBeam(ArcStopGantryAngle=179, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4",
                                          Description="4", GantryAngle=181, CouchAngle=0, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_3.SetBolus(BolusName="")

def arc6p():
    with CompositeAction('Add beam (1, Beam Set: 6arc)'):
        retval_0 = beam_set.CreateArcBeam(ArcStopGantryAngle=120, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1",
                                          Description="1", GantryAngle=178, CouchAngle=0, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_0.SetBolus(BolusName="")

    with CompositeAction('Add beam (2, Beam Set: 6arc)'):
        retval_1 = beam_set.CreateArcBeam(ArcStopGantryAngle=310, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2",
                                          Description="2", GantryAngle=50, CouchAngle=0, CollimatorAngle=10,
                                          ApertureBlock=None)

        retval_1.SetBolus(BolusName="")
    with CompositeAction('Add beam (3, Beam Set: 6arc)'):
        retval_2 = beam_set.CreateArcBeam(ArcStopGantryAngle=182, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3",
                                          Description="3", GantryAngle=240, CouchAngle=0, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_2.SetBolus(BolusName="")

    with CompositeAction('Add beam (4, Beam Set: 6arc)'):
        retval_3 = beam_set.CreateArcBeam(ArcStopGantryAngle=240, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4",
                                          Description="4", GantryAngle=182, CouchAngle=0, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_3.SetBolus(BolusName="")

    with CompositeAction('Add beam (5, Beam Set: 6arc)'):
        retval_4 = beam_set.CreateArcBeam(ArcStopGantryAngle=50, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5",
                                          Description="5", GantryAngle=310, CouchAngle=0, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_4.SetBolus(BolusName="")

    with CompositeAction('Add beam (6, Beam Set: 6arc)'):
        retval_5 = beam_set.CreateArcBeam(ArcStopGantryAngle=178, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="6",
                                          Description="6", GantryAngle=120, CouchAngle=0, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_5.SetBolus(BolusName="")

def arc105ang():
    with CompositeAction('Add beam (1, Beam Set: 5ANG-10ARC)'):
        retval_0 = beam_set.CreateArcBeam(ArcStopGantryAngle=182, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1",
                                          Description="1", GantryAngle=0, CouchAngle=80, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_0.SetBolus(BolusName="")

    with CompositeAction('Add beam (2, Beam Set: 5ANG-10ARC)'):
        retval_1 = beam_set.CreateArcBeam(ArcStopGantryAngle=0, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2",
                                          Description="2", GantryAngle=182, CouchAngle=80, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_1.SetBolus(BolusName="")
    ...
    with CompositeAction('Add beam (3, Beam Set: 5ANG-10ARC)'):
        retval_2 = beam_set.CreateArcBeam(ArcStopGantryAngle=182, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3",
                                          Description="3", GantryAngle=0, CouchAngle=40, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_2.SetBolus(BolusName="")

    with CompositeAction('Add beam (4, Beam Set: 5ANG-10ARC)'):
        retval_3 = beam_set.CreateArcBeam(ArcStopGantryAngle=0, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4",
                                          Description="4", GantryAngle=182, CouchAngle=40, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_3.SetBolus(BolusName="")

    with CompositeAction('Add beam (5, Beam Set: 5ANG-10ARC)'):
        retval_4 = beam_set.CreateArcBeam(ArcStopGantryAngle=182, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5",
                                          Description="5", GantryAngle=178, CouchAngle=0, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_4.SetBolus(BolusName="")
    ...
    with CompositeAction('Add beam (6, Beam Set: 5ANG-10ARC)'):
        retval_5 = beam_set.CreateArcBeam(ArcStopGantryAngle=178, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="6",
                                          Description="6", GantryAngle=182, CouchAngle=0, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_5.SetBolus(BolusName="")

    with CompositeAction('Add beam (7, Beam Set: 5ANG-10ARC)'):
        retval_6 = beam_set.CreateArcBeam(ArcStopGantryAngle=0, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="7",
                                          Description="7", GantryAngle=178, CouchAngle=320, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_6.SetBolus(BolusName="")

    with CompositeAction('Add beam (8, Beam Set: 5ANG-10ARC)'):
        retval_7 = beam_set.CreateArcBeam(ArcStopGantryAngle=178, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="8",
                                          Description="8", GantryAngle=0, CouchAngle=320, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_7.SetBolus(BolusName="")

    with CompositeAction('Add beam (9, Beam Set: 5ANG-10ARC)'):
        retval_8 = beam_set.CreateArcBeam(ArcStopGantryAngle=0, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="9",
                                          Description="9", GantryAngle=178, CouchAngle=280, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_8.SetBolus(BolusName="")

    with CompositeAction('Add beam (10, Beam Set: 5ANG-10ARC)'):
        retval_9 = beam_set.CreateArcBeam(ArcStopGantryAngle=178, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="10",
                                          Description="10", GantryAngle=0, CouchAngle=280, CollimatorAngle=350,
                                          ApertureBlock=None)
...
def arc99ang():
    ...
    with CompositeAction('Add beam (2, Beam Set: 9ANG-9ARC)'):
        retval_1 = beam_set.CreateArcBeam(ArcStopGantryAngle=20, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2",
                                          Description="2", GantryAngle=182, CouchAngle=20, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_1.SetBolus(BolusName="")
    ...
    with CompositeAction('Add beam (3, Beam Set: 9ANG-9ARC)'):
        retval_2 = beam_set.CreateArcBeam(ArcStopGantryAngle=182, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3",
                                          Description="3", GantryAngle=20, CouchAngle=40, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_2.SetBolus(BolusName="")

    with CompositeAction('Add beam (4, Beam Set: 9ANG-9ARC)'):
        retval_3 = beam_set.CreateArcBeam(ArcStopGantryAngle=20, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4",
                                          Description="4", GantryAngle=182, CouchAngle=60, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_3.SetBolus(BolusName="")
    ...
    with CompositeAction('Add beam (5, Beam Set: 9ANG-9ARC)'):
        retval_4 = beam_set.CreateArcBeam(ArcStopGantryAngle=182, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5",
                                          Description="5", GantryAngle=20, CouchAngle=80, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_4.SetBolus(BolusName="")
    ...
    with CompositeAction('Add beam (6, Beam Set: 9ANG-9ARC)'):
        retval_5 = beam_set.CreateArcBeam(ArcStopGantryAngle=178, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="6",
                                          Description="6", GantryAngle=340, CouchAngle=280, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_5.SetBolus(BolusName="")

    with CompositeAction('Add beam (7, Beam Set: 9ANG-9ARC)'):
        retval_6 = beam_set.CreateArcBeam(ArcStopGantryAngle=340, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="7",
                                          Description="7", GantryAngle=178, CouchAngle=300, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_6.SetBolus(BolusName="")
    ...
    with CompositeAction('Add beam (8, Beam Set: 9ANG-9ARC)'):
        retval_7 = beam_set.CreateArcBeam(ArcStopGantryAngle=178, ArcRotationDirection="Clockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="8",
                                          Description="8", GantryAngle=340, CouchAngle=320, CollimatorAngle=10,
                                          ApertureBlock=None)
        retval_7.SetBolus(BolusName="")

    with CompositeAction('Add beam (9, Beam Set: 9ANG-9ARCc)'):
        retval_8 = beam_set.CreateArcBeam(ArcStopGantryAngle=340, ArcRotationDirection="CounterClockwise", Energy=6,
                                          MachineCone=None, Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="9",
                                          Description="9", GantryAngle=178, CouchAngle=340, CollimatorAngle=350,
                                          ApertureBlock=None)
        retval_8.SetBolus(BolusName="")

def f1b4():
    with CompositeAction('Add beam (1, Beam Set: 1)'):
        retval_2 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1", Description="1",
                                             GantryAngle=165, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_2.SetBolus(BolusName="")
        beam_set.Beams['1'].BeamMU = 0


    with CompositeAction('Add beam (2, Beam Set: 1)'):
        retval_3 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2", Description="2",
                                             GantryAngle=135, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_3.SetBolus(BolusName="")
        beam_set.Beams['2'].BeamMU = 0

    with CompositeAction('Add beam (3, Beam Set: 1)'):
        retval_4 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3", Description="3",
                                             GantryAngle=0, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_4.SetBolus(BolusName="")
        beam_set.Beams['3'].BeamMU = 0

    with CompositeAction('Add beam (4, Beam Set: 1)'):
        retval_5 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4", Description="4",
                                             GantryAngle=225, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_5.SetBolus(BolusName="")
        beam_set.Beams['4'].BeamMU = 0

    with CompositeAction('Add beam (5, Beam Set: 1)'):
        retval_6 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5", Description="5",
                                             GantryAngle=195, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_6.SetBolus(BolusName="")
...
def f1b4and2():
    ...
    with CompositeAction('Add beam (3, Beam Set: 1)'):
        retval_4 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3", Description="3",
                                             GantryAngle=40, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_4.SetBolus(BolusName="")
        beam_set.Beams['3'].BeamMU = 0
    ...
    with CompositeAction('Add beam (5, Beam Set: 1)'):
        retval_6 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5", Description="5",
                                             GantryAngle=320, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_6.SetBolus(BolusName="")
        beam_set.Beams['5'].BeamMU = 0

    with CompositeAction('Add beam (6, Beam Set: 1)'):
        retval_7 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="6", Description="6",
                                             GantryAngle=225, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_7.SetBolus(BolusName="")
        beam_set.Beams['6'].BeamMU = 0

    with CompositeAction('Add beam (7, Beam Set: 1)'):
        retval_8 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="7", Description="7",
                                             GantryAngle=195, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_8.SetBolus(BolusName="")
...
def f3b2():
    with CompositeAction('Add beam (1, Beam Set: 1)'):
        retval_2 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1", Description="1",
                                             GantryAngle=160, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_2.SetBolus(BolusName="")
        beam_set.Beams['1'].BeamMU = 0
    ...
    with CompositeAction('Add beam (5, Beam Set: 1)'):
        retval_6 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5", Description="5",
                                             GantryAngle=200, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_6.SetBolus(BolusName="")
        beam_set.Beams['5'].BeamMU = 0
...
def bst4l():
    with CompositeAction('Add beam (1, Beam Set: 1)'):
        retval_2 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1", Description="1",
                                             GantryAngle=120, CouchAngle=0, CollimatorAngle=340, ApertureBlock=None)
        retval_2.SetBolus(BolusName="")
        beam_set.Beams['1'].BeamMU = 0
    ...
    with CompositeAction('Add beam (2, Beam Set: 1)'):
        retval_3 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2", Description="2",
                                             GantryAngle=106, CouchAngle=0, CollimatorAngle=340, ApertureBlock=None)
        retval_3.SetBolus(BolusName="")
        beam_set.Beams['2'].BeamMU = 0
    ...
    with CompositeAction('Add beam (3, Beam Set: 1)'):
        retval_4 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3", Description="3",
                                             GantryAngle=310, CouchAngle=0, CollimatorAngle=20, ApertureBlock=None)
        retval_4.SetBolus(BolusName="")
        beam_set.Beams['3'].BeamMU = 0
    ...
    with CompositeAction('Add beam (4, Beam Set: 1)'):
        retval_5 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4", Description="4",
                                             GantryAngle=295, CouchAngle=0, CollimatorAngle=20, ApertureBlock=None)
        retval_5.SetBolus(BolusName="")
        beam_set.Beams['4'].BeamMU = 0
...
def bst4r():
    with CompositeAction('Add beam (1, Beam Set: 1)'):
        retval_2 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1", Description="1",
                                             GantryAngle=62, CouchAngle=0, CollimatorAngle=340, ApertureBlock=None)
        retval_2.SetBolus(BolusName="")
        beam_set.Beams['1'].BeamMU = 0
    ...
    with CompositeAction('Add beam (2, Beam Set: 1)'):
        retval_3 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2", Description="2",
                                             GantryAngle=48, CouchAngle=0, CollimatorAngle=340, ApertureBlock=None)
        retval_3.SetBolus(BolusName="")
        beam_set.Beams['2'].BeamMU = 0
    ...
    with CompositeAction('Add beam (3, Beam Set: 1)'):
        retval_7 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3", Description="3",
                                             GantryAngle=251, CouchAngle=0, CollimatorAngle=20, ApertureBlock=None)
        retval_7.SetBolus(BolusName="")
        beam_set.Beams['3'].BeamMU = 0
    ...
    with CompositeAction('Add beam (4, Beam Set: 1)'):
        retval_8 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4", Description="4",
                                             GantryAngle=237, CouchAngle=0, CollimatorAngle=20, ApertureBlock=None)
        retval_8.SetBolus(BolusName="")
        beam_set.Beams['4'].BeamMU = 0
...
def avg5():
    with CompositeAction('Add beam (1, Beam Set: 1)'):
        retval_2 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1", Description="1",
                                             GantryAngle=140, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_2.SetBolus(BolusName="")
        beam_set.Beams['1'].BeamMU = 0
    ...
    with CompositeAction('Add beam (2, Beam Set: 1)'):
        retval_3 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2", Description="2",
                                             GantryAngle=60, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_3.SetBolus(BolusName="")
        beam_set.Beams['2'].BeamMU = 0
    ...
    with CompositeAction('Add beam (4, Beam Set: 1)'):
        retval_5 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="4", Description="4",
                                             GantryAngle=300, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_5.SetBolus(BolusName="")
        beam_set.Beams['4'].BeamMU = 0
    ...
    with CompositeAction('Add beam (5, Beam Set: 1)'):
        retval_6 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5", Description="5",
                                             GantryAngle=230, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_6.SetBolus(BolusName="")
        beam_set.Beams['5'].BeamMU = 0
...
def avg7():
    with CompositeAction('Add beam (1, Beam Set: 1)'):
        retval_2 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="1", Description="1",
                                             GantryAngle=150, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_2.SetBolus(BolusName="")
        beam_set.Beams['1'].BeamMU = 0
    ...
    with CompositeAction('Add beam (2, Beam Set: 1)'):
        retval_3 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2", Description="2",
                                             GantryAngle=100, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_3.SetBolus(BolusName="")
        beam_set.Beams['2'].BeamMU = 0
    ...
    with CompositeAction('Add beam (3, Beam Set: 1)'):
        retval_4 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3", Description="3",
                                             GantryAngle=50, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_4.SetBolus(BolusName="")
        beam_set.Beams['3'].BeamMU = 0
    ...
    with CompositeAction('Add beam (5, Beam Set: 1)'):
        retval_6 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="5", Description="5",
                                             GantryAngle=310, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_6.SetBolus(BolusName="")
        beam_set.Beams['5'].BeamMU = 0
    ...
    with CompositeAction('Add beam (6, Beam Set: 1)'):
        retval_7 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="6", Description="6",
                                             GantryAngle=260, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_7.SetBolus(BolusName="")
        beam_set.Beams['6'].BeamMU = 0
    ...
    with CompositeAction('Add beam (7, Beam Set: 1)'):
        retval_8 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="7", Description="7",
                                             GantryAngle=210, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_8.SetBolus(BolusName="")
        beam_set.Beams['7'].BeamMU = 0
...
def avg9():
    ...
    with CompositeAction('Add beam (2, Beam Set: 1)'):
        retval_3 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="2", Description="2",
                                             GantryAngle=120, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_3.SetBolus(BolusName="")
        beam_set.Beams['2'].BeamMU = 0
    ...
    with CompositeAction('Add beam (3, Beam Set: 1)'):
        retval_4 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="3", Description="3",
                                             GantryAngle=80, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_4.SetBolus(BolusName="")
        beam_set.Beams['3'].BeamMU = 0
    ...
    with CompositeAction('Add beam (7, Beam Set: 1)'):
        retval_8 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="7", Description="7",
                                             GantryAngle=280, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_8.SetBolus(BolusName="")
        beam_set.Beams['7'].BeamMU = 0

    with CompositeAction('Add beam (8, Beam Set: 1)'):
        retval_9 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="8", Description="8",
                                             GantryAngle=240, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_9.SetBolus(BolusName="")
        beam_set.Beams['8'].BeamMU = 0

    with CompositeAction('Add beam (9, Beam Set: 1)'):
        retval_0 = beam_set.CreatePhotonBeam(Energy=6, BlockTray=None, Cone=None, MachineCone=None, Wedge=None,
                                             Isocenter={'x': isox, 'y': isoy, 'z': isoz}, Name="9", Description="9",
                                             GantryAngle=200, CouchAngle=0, CollimatorAngle=0, ApertureBlock=None)
        retval_0.SetBolus(BolusName="")
...
hipdic=['HIPPO']
lendic=['LEN-R','LENS-R','LEN-L','LENS-L','LENL','LENR','L LENS','R LENS','LENS R','LENS L','LENS RIGHT','LENS LEFT']
ondic=['ON-L','ON-R','OPTIC NERVE-R','OPTIC NERVE-L','ONL','ONR','OPTIC NERVE LEFT','OPTIC NERVE RIGHT']
bsdic=['BRAINSTEM','BRAIN-STEM','BS','BRAIN STEM']
corddic=['CORD','SPINALCORD','SPINALCORD (THORAX)','SPINAL CORD']
...
parotiddic=['PAROTID-R','PAROTID-L','PAROTID R','PAROTID L','PAROTIDGLAND (LEFT)','PAROTIDGLAND (RIGHT)','PAROTID LEFT','PAROTID RIGHT']
femoraldic=['FEMORAL HEAD R','FEMORAL HEAD L','FEMORALHEAD (LEFT)','FEMORALHEAD (RIGHT)','FEMUR HEAD LEFT','FEMUR HEAD LEFT']
heartdic=['HEART']
liverdic=['LIVER']
kiddic=['KIDNEY-L','KIDNEY (LEFT)','KIDNEY-R','KIDNEY (RIGHT)','KIDNEY LEFT','KIDNEY RIGHT']
bladdic=['BLADDER']
rectumdic=['RECTUM']
stomachdic=['STOMACH'] #NONE ADDED #
pancreasdic=['PANCREAS'] #NONE ADDED#
prostatedic=['PROSTATE'] #NONE ADDED#
seminaldic=['SEMINAL VESICLE'] #NONE ADDED#
oraldic=['ORAL CAVITY','ORAL']  #NONE ADDED#
redic=['1']
...
if 'BREASTCTRL.VMAT' in roi_names or 'BREASTCTRL.IMRT' in roi_names:
    ...
    if len(cordls) != 0:
        for ci in cordls:
            if 'cm' not in roi_names:
                with CompositeAction('ROI Algebra (cm)'):
                    retval_0 = patient.PatientModel.CreateRoi(Name="cm", Color="Cyan", Type="Organ", TissueName=None,
                                                              RoiMaterial=None)
                    retval_0.SetAlgebraExpression(ExpressionA={'Operation': "Union", 'SourceRoiNames': [ci],
                                                  ...
                                                  ResultMarginSettings={'Type': "Expand", 'Superior': 0.3,
                                                                        'Inferior': 0.3, 'Anterior': 0.3,
    ...
    if len(lungls) != 0:
        if len(lungls) == 2:
            if "Lung-Z" not in roi_names:
                with CompositeAction('ROI Algebra (Lung-Z)'):
                    retval_0 = patient.PatientModel.CreateRoi(Name="Lung-Z", Color="Pink", Type="Organ",
                                                              TissueName=None, RoiMaterial=None)
                    retval_0.SetAlgebraExpression(
                        ExpressionA={'Operation': "Union", 'SourceRoiNames': [lungls[0], lungls[1]],
...
def TimeStampToDate(timestamp):
    ...
    return timeStruct.date()

def get_FileCreateTime(filePath):
    t = os.path.getctime(filePath)
    return TimeStampToDate(t)

def daysdelta(dfile,dnow):
    dd = dnow-dfile
    return dd.days

dosefn='\\\SQL\\Share\\Public\\rayx\\oarsubdose'

dfile=get_FileCreateTime(dosefn)
dnow=now.date()

xy=[]
xy.append('PatientID,' + patient.PatientID + ',')

if os.path.exists(dosefn):
    pass
else:
    with open (dosefn ,'w') as f:
        f.write ('')
dp=get_FileCreateTime(dosefn)

if daysdelta(dp,dnow) != 0:
    with open (dosefn ,'w') as f:
        tl = len(fncoar)
        for i in range(tl):
            m = fncoar[i] + ',' + str(fncdose[i]) + ',' + str(fncvol[i]) + ',' + str(fncwht[i])+','
            xy.append(m)
        for z in xy:
            f.write(z)
        f.write('\t\n')
...
def getoarvdose(oarname,rel_vol):
    frac = beam_set.FractionationPattern.NumberOfFractions
    oardose = beam_set.FractionDose.GetDoseAtRelativeVolumes(RoiName=oarname, RelativeVolumes=[rel_vol/100])[0] * frac
    return oardose

def getoarmaxdose(oarname):
    frac = beam_set.FractionationPattern.NumberOfFractions
    oarmaxdose = beam_set.FractionDose.GetDoseStatistic(RoiName=oarname,DoseType='Max')*frac
    return oarmaxdose

def getoaravgdose(oarname):
    frac = beam_set.FractionationPattern.NumberOfFractions
    oaravgdose = beam_set.FractionDose.GetDoseStatistic(RoiName=oarname,DoseType='Average')*frac
    return oaravgdose

def cfchange():
    for i in range(len(fncoar)):
        if fncvol[i]==0:
            oarname=fncoar[i]
            if fncdose[i] > getoarmaxdose(oarname):
                fncdose[i]= int(getoarmaxdose(oarname)*0.8)
                with CompositeAction('Add Optimization Function'):
                    retval_2 = po.AddOptimizationFunction(FunctionType="MaxDose", RoiName=oarname)
                    retval_2.DoseFunctionParameters.DoseLevel = fncdose[i]
                    retval_2.DoseFunctionParameters.Weight = fncwht[i]
                 
        if fncvol[i]==100:
            oarname=fncoar[i]
            if fncdose[i] > getoaravgdose(oarname):
                fncdose[i]= int(getoaravgdose(oarname)*0.8)
                with CompositeAction('Add Optimization Function'):
                    retval_2 = po.AddOptimizationFunction(FunctionType="MaxEud", RoiName=oarname)
                    retval_2.DoseFunctionParameters.DoseLevel = fncdose[i]
                    retval_2.DoseFunctionParameters.EudParameterA = 1
                    retval_2.DoseFunctionParameters.Weight = fncwht[i]
              
        if fncvol[i] !=0 and fncvol[i]!=100:
            oarname=fncoar[i]
            if fncdose[i] > getoarvdose(oarname,float(fncvol[i])):
                fncdose[i]= int(getoarvdose(oarname,float(fncvol[i]))*0.8)
                with CompositeAction('Add Optimization Function'):
                    retval_2 = po.AddOptimizationFunction(FunctionType="MaxDVH", RoiName=oarname)
                    retval_2.DoseFunctionParameters.DoseLevel = fncdose[i]
                    retval_2.DoseFunctionParameters.PercentVolume = fncvol[i]
                    retval_2.DoseFunctionParameters.Weight = fncwht[i]
#fncoar=[]
#fncdose=[]
#fncvol=[]
...
#with open (dosefn, 'r') as f:
#    lines=f.readlines()
#    for i in range(len(lines)):
#        if len(lines[i])!=0:
#            if lines[i].split(',')[0]=='PatientID' and lines[i].split(',')[1]==patient.PatientID:
#                oarstrf=lines[i].split(',')[2:-1]
#                oarnb=len(oarstrf)/4
#                for i in range(oarnb):
#                    fncoar.append(oarstrf[4*i])
#                    fncdose.append(int(oarstrf[4*i+1]))
#                    fncvol.append(int(oarstrf[4*i+2]))
#                    fncwht.append(int(oarstrf[4*i+3]))
#            break 

#with open ('\\\SQL\\Share\\Public\\rayx\\xyz', 'w') as f:
#    for x in oarn:
#        f.write(x)
#    f.write('\t\n')
#    for y in oard:
